...
class Infection {
    ...
    */
    ...
    constructor(actor) {
        ...
        this.daysToContagious = gaussianRandom(params.daysToContagious);
        this.daysToNotContagious = this.daysToContagious + gaussianRandom(params.daysToRecovery-params.daysToContagious);
