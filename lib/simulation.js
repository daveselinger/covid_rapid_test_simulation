...
class Infection {
    ...
    */
    ...
    constructor(actor) {
        ...
        this.durationDaysOfAntigenDetection = gaussianRandom(params.durationDaysOfAntigenDetection);
        this.durationDaysOfPCRDetection = gaussianRandom(params.durationDaysOfPCRDetection);
    }
    ...
    detectedPCRTest() {
        return this.duration() > this.daysToPcrDetectable && this.duration() < 30;
    }

    detectRapidTest() {
        return this.duration() > this.daysToAntigenDetectable && this.duration() < this.durationDaysOfAntigenDetection;
    }
}
